...
/**
 * Modelo de un Pokémon usado desde el Nivel 3 en adelante. Es una clase de
 * datos pura (SRP): solo guarda el estado, sin lógica de negocio.
 */
public class Pokemon {
    ...
    public String toString() {
        return nombre + "(PC:" + (int) poderCombate + ")";
    }
}
